...
<!-- White hero section -->
<div class="bg-white relative overflow-hidden min-h-screen flex items-center">
  
  <div class="relative mx-auto w-full max-w-[900px] px-4 sm:px-0 py-20">
    <div class="text-center space-y-8 mb-16">
      <!-- Badge/tag -->
      <div class="inline-flex items-center px-4 py-2 bg-blue-50 text-blue-700 rounded-full text-sm font-medium mb-4">
      ...
      <p class="text-2xl sm:text-3xl text-gray-600 max-w-5xl mx-auto leading-relaxed">
        Build, publish, and sell fully-functioning apps that can accept payments immediately. <span class="font-semibold text-gray-800">No coding necessary.</span>
      </p>
    ...
    <div class="text-center">
      <a href="https://app.madewithmanifest.com/login?onboarding=1" class="inline-flex items-center bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white font-semibold px-10 py-5 rounded-lg text-xl transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5">
