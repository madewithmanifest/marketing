    ...
    <div class="bg-white rounded-lg shadow-lg p-8 space-y-8">
      ...
      <section>
        ...
        <ul class="list-disc pl-6 space-y-2 text-gray-700">
          ...
          <li>Application data and content you create using our platform</li>
      ...
      <section>
        ...
        <p class="text-gray-700 mb-4">
          We use cookies and similar tracking technologies to collect usage information and improve our services. You can control cookie settings through your browser preferences.
        </p>
      </section>
      ...
      <section>
        ...
        <p class="text-gray-700">
          If you have any questions about this privacy policy, please contact us at: <a href="mailto:privacy@madewithmanifest.com" class="text-blue-600 hover:text-blue-700">privacy@madewithmanifest.com</a>
        </p>
      </section>
